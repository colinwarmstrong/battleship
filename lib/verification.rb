module Verification
  ...
  def verify_destroyer(coordinates, grid)
    ...
    verify_destroyer_horizontal_or_vertical(numeric_coord, grid)
    verify_destroyer_units_are_adjacent(numeric_coord, grid)
  end
  ...
  def verify_destroyer_horizontal_or_vertical(numeric_coord, grid)
  ...
  def verify_destroyer_units_are_adjacent(numeric_coord, grid)
  ...
  def verify_submarine(coordinates, grid)
    ...
    verify_sub_horizontal_or_vertical(numeric_coord, grid)
    verify_sub_units_are_adjacent(numeric_coord, grid)
  ...
  def verify_sub_horizontal_or_vertical(numeric_coord, grid)
  ...
  def verify_sub_units_are_adjacent(numeric_coord, grid)
